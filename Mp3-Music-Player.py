...
def addsongs():
    ...
    for s in temp_song:
        s=s.replace("C:/Users/Nida/OneDrive/Desktop/Python Project/","")
...
def Play():
    ...
    song=f'C:/Users/Nida/OneDrive/Desktop/Python Project/{song}'
...
def Previous():
    ...
    temp2=f'C:/Users/Nida/OneDrive/Desktop/Python Project/{temp2}'
...
def Next():
    ...
    temp=f'C:/Users/Nida/OneDrive/Desktop/Python Project/{temp}'
...
root=Tk()
root.title('MP3 Music Player App ')
#initialize mixer 
mixer.init()
